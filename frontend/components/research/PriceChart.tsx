  ...
  return (
    <div className="py-4">
      <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
        <div>
          <div className="text-sm font-medium text-primary">Historical Close Price</div>
          <div className="text-xs text-muted">Daily close history from the research data provider.</div>
        </div>
